    ...
    public class IconPackList
    {
        ...
        public static async Task<ObservableCollection<IconPackViewModel>> CreateIconPackList(HomePageViewModel vm, ObservableCollection<IconPackViewModel> collection = null)
        {
            ...
            new[]
            {
                    ...
                    new IconPackViewModel(vm, "BootstrapIcons", typeof(PackIconBootstrapIconsKind), typeof(PackIconBootstrapIcons)),
                    new IconPackViewModel(vm, "BoxIcons", typeof(PackIconBoxIconsKind), typeof(PackIconBoxIcons)),
                    new IconPackViewModel(vm, "Codicons", typeof(PackIconCodiconsKind), typeof(PackIconCodicons)),
                    ...
                    new IconPackViewModel(vm, "FileIcons", typeof(PackIconFileIconsKind), typeof(PackIconFileIcons)),
                    new IconPackViewModel(vm, "Fontaudio", typeof(PackIconFontaudioKind), typeof(PackIconFontaudio)),
                    new IconPackViewModel(vm, "FontAwesome", typeof(PackIconFontAwesomeKind), typeof(PackIconFontAwesome)),
                    new IconPackViewModel(vm, "ForkAwesome", typeof(PackIconForkAwesomeKind), typeof(PackIconForkAwesome)),
                    ...
                    new IconPackViewModel(vm, "PixelartIcons", typeof(PackIconPixelartIconsKind), typeof(PackIconPixelartIcons)),
                    new IconPackViewModel(vm, "RadixIcons", typeof(PackIconRadixIconsKind), typeof(PackIconRadixIcons)),
                    new IconPackViewModel(vm, "RemixIcon", typeof(PackIconRemixIconKind), typeof(PackIconRemixIcon)),
                    ...
                    new IconPackViewModel(vm, "VaadinIcons", typeof(PackIconVaadinIconsKind), typeof(PackIconVaadinIcons)),
